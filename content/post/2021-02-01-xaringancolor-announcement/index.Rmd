...
xaringanExtra::embed_xaringan(url = "css-example.html", ratio = "7:5")
```
...
```{r, echo=FALSE, eval=TRUE}
xaringanExtra::embed_xaringan(url = "flair-example.html", ratio = "7:5")
```
...
```{r, echo=FALSE, eval=TRUE}
xaringanExtra::embed_xaringan(url = "latex-example.html", ratio = "7:5")
```
...
```{r, echo=FALSE, eval=TRUE}
xaringanExtra::embed_xaringan(url = "andrew-example.html", ratio = "7:5")
```
