...
The data we will be using is the text from *Pride and Prejudice* and text from *The War of the Worlds*. These texts can we get from [Project Gutenberg](https://www.gutenberg.org/) using the [gutenbergr](https://github.com/ropensci/gutenbergr) package.
